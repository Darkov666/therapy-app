...
const page = usePage();
// Filter categories to only show 'product' type
            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100">Información del Producto</h3>
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            Detalles del producto digital a la venta.
                        </p>
                    </div>
                </div>
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input
                                        ...
                                        class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-primary-50 file:text-primary-700 hover:file:bg-primary-100"
                                    />
                                    <p class="text-xs text-gray-500 mt-1">Este archivo solo será accesible tras la compra.</p>
